...
message = """
Looking at the world and the two measurements, Red and Red, we can see that the most
probable the Robot would have started is 2nd grid-cell.
If that was the case, then after two moves, the Robot should now be in 4th Gird-Cell.
When we look at the final posterior probability, we see that Robot think so too,
as the probability value of the 4th grid-cell is the highest indicating that Robot
thinks with a higher confidence that it's current location is grid-cell 4 
"""
