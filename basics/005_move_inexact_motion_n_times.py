...
for i in range(n_steps):
    p = move(p, 1)
    print(f"After Move {i}: {p}")

print("\nNotice with increasing n, the robot becomes more and more uncertain")
print("\nUntil it settles with the maximum uncertainty; uniform distribution")
